...
# Køkkenet, rum(2)        
        ...
        elif user_inp in ["åben kistet" , "kiste åbning"]:
            print("Ind i kistet, stå der en dagblad, hvor det sagte at Lidl søger efter medarbejder og der stå deres telefonnummer")
            print("Du har ringet til dem og du fik et job i Lidl, du har arbejdet 7,29 og du har nok penger til at betaler din gælden til staten ")
            print("Tillykke!! Du har vundet spillet!! :)")
            break
...
# Badeværelset, rum(3)
            ...
            print("På det samme tid, du fik et nøgle ud fra toillet. Måske du kan gøre noget med det senere?! ")
...
#hjælpekommandoer
        elif user_inp in ["hjælp" , "help"]:
            print("Her er nogle forskellige kommandoer til hver rum:")
            if current_room == 0:
                if lyset_tændt:
                    print("")
